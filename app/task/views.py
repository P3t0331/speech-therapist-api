...
class TaskViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        The returned queryset can be filtered based on the following query parameters:
            - default: If set to True, only tasks created by the default user will be included in the queryset.
            - custom: If set to True, only tasks that are marked as custom will be included in the queryset.
            - generated: If set to True, only tasks that are not created by the default user and are not marked as custom will be included in the queryset.
        If no query parameters are provided, the queryset will not be filtered and will be ordered by the task id in descending order.
        """
    ...
    def get_permissions(self):
        """
        Check permissions for the request. If the user does not have the required permissions, return a permission denied error.
        """
    ...
    def get_serializer_class(self):
        """
        Return the appropriate serializer class for the request based on the `task_type` query parameter.
        If the `task_type` query parameter is not provided, the default `TaskDetailSerializer` will be used.
        The possible values for the `task_type` query parameter and the corresponding serializer classes are:
    ...
    def perform_create(self, serializer):
        """
        Create a new Task.
        The created_by field of the Task will be set to the authenticated user and the is_custom field will be set to True
        if the serializer class is either `CustomTaskDetailSerializer` or `FourChoicesTaskDetailSerializer`.
        """
    ...
    def update(self, request, *args, **kwargs):
        ...
        if self.get_serializer_class() == serializers.TaskDetailSerializer:
            raise UpdateNotAllowedException({"detail": "Update is not allowed for this generated task type"})
...
class BasicChoiceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        """
        Retrieve the BasicChoices in the database, ordered by the id in descending order.
        """
        return self.queryset.order_by('-id').distinct()
    ...
    def perform_create(self, serializer):
        ...
        The created_by field of the BasicChoice will be set to the authenticated user.
        """
        serializer.save(created_by=self.request.user)
...
class TagViewSet(mixins.DestroyModelMixin,
    ...
    def get_queryset(self):
        """
        Retrieve the tags in the database that are associated with the authenticated user, ordered by the name in descending order.
        """
...
class TaskResultViewSet(mixins.CreateModelMixin,
    ...
    def get_serializer_class(self):
        """
        Return the appropriate serializer class for the request based on the `task_type` query parameter.
        If the `task_type` query parameter is not provided, the default `TaskDetailResultSerializer` will be used.
        The possible values for the `task_type` query parameter and the corresponding serializer classes are:
    ...
    def get_permissions(self):
        ...
        If the request is a `destroy` or `retrieve` action, the user must have the `IsAuthenticated`, `IsTherapist`, and `IsTaskResultMyPatient` permissions.
    ...
    def get_queryset(self):
        """
        Retrieve the TaskResults in the database, ordered by the id in descending order.
        """
    ...
    def perform_create(self, serializer):
        ...
        The `answered_by` field of the `TaskResult` will be set to the authenticated user.
        The `date_created` field of the `TaskResult` will be set to the current time.
        The `last_result_posted` field of the authenticated user will be set to the current time.
        """
